...
#Thearding allows us to speed up programs by executing multiple at the SAME time.
...
def function3():
    for i in range(10):
        print("THREE")
# If we call these function ,we see the first function call MUST complete before the next
#They are excecuted linearly
# function1()
# function2()
# function3()
